...
var event_routes = require('./routes/api-routes'); 
//cargamos morgan
...
app.get('/', (req, res) => res.send('Hello World with Express Event'));

// Use Api routes in the App
app.use('/api-docs/event', swaggerUi.serve, swaggerUi.setup(swaggerDocument));
